       ...
       <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="space-y-6 animate-slide-in-right" style={{ animationDelay: '0.2s' }}>
                ...
                {/* Map */}
                <div className="rounded-3xl overflow-hidden border-4 border-white shadow-xl h-64 md:h-80 hover:shadow-2xl transition-all duration-500 relative group">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3618.6847!2d-53.4582478!3d-24.954937!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94f3d58b37113d87%3A0x1440bf8abd097da1!2sRay%20Sexshop%20%26%20moda%20%C3%ADntima!5e0!3m2!1spt-BR!2sbr!4v1734195867000!5m2!1spt-BR!2sbr"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                ...
                <a
                    href="https://www.google.com.br/maps/place/Ray+Sexshop+%26+moda+%C3%ADntima/@-24.9547488,-53.4600889,16.75z/data=!4m6!3m5!1s0x94f3d58b37113d87:0x1440bf8abd097da1!8m2!3d-24.954937!4d-53.4582478!16s%2Fg%2F11zjxczmvx?entry=ttu&g_ep=EgoyMDI1MTIwOC4wIKXMDSoASAFQAw%3D%3D"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold py-4 px-6 rounded-2xl text-sm uppercase tracking-wider hover:from-blue-700 hover:to-blue-600 transition-all duration-300 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/40 flex items-center justify-center gap-3 group active:scale-95"
                >
